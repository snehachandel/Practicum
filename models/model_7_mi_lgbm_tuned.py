...
def main():
    ...
    top_indices = mi_selector.get_support(indices=True)
    ...
    print("\nSaving Model 7 artifacts...")
    with open(os.path.join(script_dir, 'career_model_7.pkl'), 'wb') as f:
        pickle.dump(final_model, f)
    with open(os.path.join(script_dir, 'features_7.pkl'), 'wb') as f:
        pickle.dump(selected_features, f)
    with open(os.path.join(script_dir, 'label_encoder_7.pkl'), 'wb') as f:
        pickle.dump(le, f)
    print("Artifacts saved successfully: career_model_7.pkl, features_7.pkl, label_encoder_7.pkl")
